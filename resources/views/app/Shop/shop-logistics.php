<div class="view view-main">
    ...
    <div class="navbar">
        <div class="navbar-inner">
            <div class="left sliding shop-logistics-left">
                <a class="link icon-only">
                    <span class="icon-chevron-left"></span>
                </a>
            </div>
            <div class="center sliding shop-logistics-center"></div>
            <div class="right">
            </div>
        </div>
    </div>
    <!-- Pages -->
    <div class="pages">
        <div class="page" data-page="shop-logistics">
            <!-- 內容 -->
            <div class="page-content shop-logistics-content animated fadeIn">
                            ...
                            <li class="align-top scl_sum-block">
                                <div class="item-content">
                                    ...
                                    <div class="item-inner">
                                        ...
                                        <div class="item-input">
                                            <input class="scl_sum" type="number" placeholder="金額" readonly>
                                        </div>
                                    </div>
                                </div>
                            </li>
                ...
                <div class="recipient-block">
                    <div class="subtitle">收件人資訊</div>
                    <div class="list-block">
                        <ul>
                            <li class="align-top scl_receivername-block">
                                <div class="item-content">
                                    <div class="item-media"><i class="fa fa-user" aria-hidden="true"></i></div>
                                    <div class="item-inner">
                                        <div class="item-title label">姓名</div>
                                        <div class="item-input">
                                            <input class="scl_receivername" type="text" placeholder="ex: 王大明">
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="align-top scl_receivermobile-block">
                                <div class="item-content">
                                    <div class="item-media"><i class="fa fa-mobile" aria-hidden="true"></i></div>
                                    <div class="item-inner">
                                        <div class="item-title label">手機</div>
                                        <div class="item-input">
                                            <input class="scl_receivermobile" type="text" placeholder="ex: 0988888888">
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="align-top scl_receiverphone-block">
                                <div class="item-content">
                                    <div class="item-media"><i class="fa fa-phone" aria-hidden="true"></i></div>
                                    <div class="item-inner">
                                    <div class="item-title label">電話</div>
                                        <div class="item-input">
                                            <input class="scl_receiverphone" type="text" placeholder="ex: 0800888888">
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="align-top scl_email-block">
                                <div class="item-content">
                                    <div class="item-media"><i class="fa fa-envelope" aria-hidden="true"></i></div>
                                    <div class="item-inner">
                                    <div class="item-title label">Email</div>
                                        <div class="item-input">
                                            <input class="scl_email" type="text" placeholder="ex: demo@iscar.com">
                                        </div>
                                    </div>
                                </div>
                            </li>
            ...
            <div class="toolbar toolbar-bottom next-btn animated fadeInUp">
