    ...
    <div class="pages">
        <div class="page" data-page="bonus-gift">
            ...
            <script type="text/template7" id="templateShopUseInfo">
                <img data-src="{{#if ssd_picturepath}}{{md_picturepath}}{{else}}http://125.227.129.115/app/user_icon/general_user.png{{/if}}" width=120 class="user-icon lazy" onerror='this.src="http://125.227.129.115/app/user_icon/general_user.png"' />
