    ...
    <div class="pages">
        <div class="page" data-page="branch-cooperative">
            ...
            <script type="text/template7" id="templateBranchListType">
                <div class="row">
                <a href="branch-cooperative?menu={{menu}}&cate={{cate}}&listType=0" class="link"><i class="fa fa-stop"></i></a>
                ...
                <a href="branch-region-search" class="link"><i class="fa fa-filter" aria-hidden="true"></i></a>
                </div>
                <!--<div class="noUse" style="width:20%;"></div>-->
                <!-- <a href="#" class="button button-fill color-pink button-round" style="width:20%;" onclick="loginStatus('shop_favorite')">我的最愛</a>
                <a href="branch-region-search" class="button button-fill color-blue button-round" style="width:20%;">進階查詢</a>&nbsp; -->
            </script>
