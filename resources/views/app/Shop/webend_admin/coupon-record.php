<div class="view view-main">
    ...
    <div class="navbar">
        <div class="navbar-inner">
            ...
            <div class="center sliding coupon-record-title">使用紀錄</div>
            <div class="right">
    ...
    <div class="pages">
        ...
        <div class="page with-subnavbar" data-page="coupon-record">
                ...
                <li class="item-content list-item swipeout animated flipInX swipeout-{{scg_id}}">
                    <div class="swipeout-content item-content" onclick="loginCheck('{{scm_id}}',{{#if reservationdatetime}}'reserved'{{else}}'shop_available'{{/if}},'{{scg_id}}')">
                        <div class="item-media">
                            <img data-src="http://123.51.218.177:8084/shopdata/{{scm_mainpic}}" class="lazy" width=120 onerror='this.src="../app/image/imgDefault.png"' />
                        </div>
